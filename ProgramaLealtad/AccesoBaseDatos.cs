...
namespace ProgramaLealtad
{
    class AccesoBaseDatos
    {
        ...
        //String conexion = "Data Source=10.1.4.55; Initial Catalog= DB_B37638; Integrated Security=SSPI";
        String conexion = "Data Source=LUCHO; Initial Catalog= ProgramaDeLealtad; Integrated Security=SSPI";    // Base de datos en mi compu
        /**
         * Constructor
         */
